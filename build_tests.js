const existingTests = [
    ...
    },
    {
        ...
        ], answer: 2, explanation: "Les aplicacions no poden tocar hardware o tasques crítiques, han de cridar al kernel mitjançant Syscalls (open, read, fork...)."
    },
    {
    ...
    },
    {
        ...
        ], answer: 2, explanation: "Un procés pesat implica canviar tot l'espai de memòria virtual, variables, caches, llistes. Els threads d'un mateix PID ja comparteixen tot això."
    },
    {
        ...
        ], answer: 2, explanation: "Aïlla completament els serveis SO a espai usuari. Si el driver de xarxa peta, el sistema no peta."
    },
    {
        ...
        ], answer: 3, explanation: "Run a Blocked és voluntari (demano lectura a disc, la CPU va molt ràpida i m'he d'esperar). El disc avisa per HW (interrupció) i el kernel em posa de Blocked a Ready."
    },
    {
        ...
        ], answer: 1, explanation: "Sol passar al sistema FCFS (First Come, First Serve) pur on un procés gegant col·lapsa l'arribada rere seu de múltiples processos 'ràpids'."
    },
    {
        ...
        ], answer: 2, explanation: "bash per defecte tracta tot com text. La doble paràntesi $(()) invoca l'avaluació matemàtica i l'entorn de càlcul explícit de shell de linux."
    },
    {
        ...
        ], answer: 2, explanation: "Polling desgasta inútilment cicles de CPU. Amb interrupcions, el xip fa la seva, mentre CPU processa Excel o Firefox... xip avisa i CPU s'aparta un microsegon."
    },
    {
        ...
        ], answer: 1, explanation: "Qualsevol operació crítica que necessiti drets (Syscalls, traps o interrupcions físiques exteriors a l'usuari) fa que la CPU activi el Mode Kernel posant bit privilegi 0."
    },
    {
        ...
        ], answer: 1, explanation: "Cridar Win32 API o POSIX API (libc open/write) amaga la complexitat en codi compilador x86/ARM de crida per trap directe per interrupció i vector d'entrada."
    },
    {
        ...
        ], answer: 2, explanation: "SJF minimitza l'espera mitja col·locant el més ràpid primer, per evitar el comboi. Problema: En veritat NO COMPTE EL FUTUR (usant per tant heurístiques/exp net/est), i genera inanició a tasques llargues."
    },
    {
        ...
        ], answer: 2, explanation: "El pre-requisit bàsic del multiprogramat és mantenir molts processos vius a la RAM alhora. Només fa swap-out a disc dur la part estrictament necessària quan es satura la mateix."
    },
    {
        ...
        ], answer: 1, explanation: "Espera = el total acumulat només dins READY. Tornada (Turnaround) globalitza: Espera + Actiu_CPU + Temps a Blocked_E/S. Des de creació fina mort d'acomiadament."
    },
    {
        ...
        ], answer: 2, explanation: "Sistemes T-Compartit usa Timer actiu, E/S hardware normal per ser avui i peticions syscall per voluntari, cap usuari o crida pot forzar l'stay in execution run."
    }
];
...
const testsData = {
    parcial1: {
        tests_assignatura: ${JSON.stringify(existingTests, null, 2)},
        tests_generats: ${JSON.stringify(generatedTests, null, 2)}
    }
};
`;

// we will use node to create this output to a proper file
require('fs').writeFileSync('data/tests.js', jsOutput, 'utf8');
console.log("Tests object successfully created at data/tests.js");
